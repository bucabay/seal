 ...
 * edit safe when the surroundings change underneath it: a save typed against
 * one vault and environment still lands there even if the user has since
 * switched away, because nothing about the destination is read at write time.
 */
